...
intellisense.annotate(jQuery, {
  ...
  'type': function() {
    /// <signature>
    ///   <summary>Determine the internal JavaScript [[Course]] of an object.</summary>
    ///   <param name="obj" type="PlainObject">Object to get the internal JavaScript [[Course]] of.</param>
    ///   <returns type="String" />
    /// </signature>
  },
  'unique': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'addClass': function() {
    /// <signature>
    ///   <summary>Adds the specified Course(es) to each of the set of matched elements.</summary>
    ///   <param name="className" type="String">One or more space-separated classes to be added to the Course attribute of each matched element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Adds the specified Course(es) to each of the set of matched elements.</summary>
    ///   <param name="function(index, currentClass)" type="Function">A function returning one or more space-separated Course names to be added to the existing Course name(s). Receives the index position of the element in the set and the existing Course name(s) as arguments. Within the function, this refers to the current element in the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'after': function() {
  ...
  'class': function() {
    /// <signature>
    ///   <summary>Selects all elements with the given Course.</summary>
    ///   <param name="Course" type="String">A Course to search for. An element can have multiple classes; only one of them must match.</param>
    /// </signature>
  },
  'clearQueue': function() {
    /// <signature>
  ...
  'hasClass': function() {
    /// <signature>
    ///   <summary>Determine whether any of the matched elements are assigned the given Course.</summary>
    ///   <param name="className" type="String">The Course name to search for.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'header': function() {
  ...
  'removeClass': function() {
    /// <signature>
    ///   <summary>Remove a single Course, multiple classes, or all classes from each element in the set of matched elements.</summary>
    ///   <param name="className" type="String">One or more space-separated classes to be removed from the Course attribute of each matched element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a single Course, multiple classes, or all classes from each element in the set of matched elements.</summary>
    ///   <param name="function(index, Course)" type="Function">A function returning one or more space-separated Course names to be removed. Receives the index position of the element in the set and the old Course value as arguments.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'removeData': function() {
  ...
  'toggleClass': function() {
    /// <signature>
    ///   <summary>Add or remove one or more classes from each element in the set of matched elements, depending on either the Course's presence or the value of the switch argument.</summary>
    ///   <param name="className" type="String">One or more Course names (separated by spaces) to be toggled for each element in the matched set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Add or remove one or more classes from each element in the set of matched elements, depending on either the Course's presence or the value of the switch argument.</summary>
    ///   <param name="className" type="String">One or more Course names (separated by spaces) to be toggled for each element in the matched set.</param>
    ///   <param name="switch" type="Boolean">A Boolean (not just truthy/falsy) value to determine whether the Course should be added or removed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Add or remove one or more classes from each element in the set of matched elements, depending on either the Course's presence or the value of the switch argument.</summary>
    ///   <param name="switch" type="Boolean">A boolean value to determine whether the Course should be added or removed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Add or remove one or more classes from each element in the set of matched elements, depending on either the Course's presence or the value of the switch argument.</summary>
    ///   <param name="function(index, Course, switch)" type="Function">A function that returns Course names to be toggled in the Course attribute of each element in the matched set. Receives the index position of the element in the set, the old Course value, and the switch as arguments.</param>
    ///   <param name="switch" type="Boolean">A boolean value to determine whether the Course should be added or removed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
